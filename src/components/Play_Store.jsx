      ...
      <div className="left_section w-[50%]">
        ...
        <div className="blocks">
          <div className="row1 flex gap-6 mb-3">
            <img src="/Play_store_images/block1.png" alt="" />
            <img src="/Play_store_images/block2.png" alt="" />
          </div>

          <div className="row2 flex gap-6">
            <img src="/Play_store_images/block3.png" alt="" />
            <img src="/Play_store_images/block4.png" alt="" />
          </div>

          <div className="row-3 flex gap-3 mt-10">
            <a href="">
              <img src="/Play_store_images/playstore.png" alt="" />
            </a>
            <a href="">
              <img src="/Play_store_images/appstore.png" alt="" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="right-section w-[50%]">
        <div className="first-row flex">
          <img
            ...
            src="/Play_store_images/Frame 1000007067.png"
            alt=""
          />
          <img
            className="w-20 h-20 mt-20"
            src="/Play_store_images/left_Arrow.png"
            alt=""
          />
          <img
            className=""
            src="/Play_store_images/Frame 1000007060.png"
            alt=""
          />
        </div>
        <div className="flex">
          <img
            ...
            src="/Play_store_images/Frame 1000007061.png"
            alt=""
          />
          <img
            className="w-15 h-15 ml-5 mt-5"
            src="/Play_store_images/left_Arrow_2.png"
            alt=""
          />
        </div>
      </div>
